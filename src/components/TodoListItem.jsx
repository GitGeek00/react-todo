        ...
        <>
            <li className="alignLeft">
                <h2>
                    ...
                    &nbsp;{todo}
                    <button className="button2" type="button" onClick={onRemoveTodo}>
